    ...
    <tr className="transition-colors hover:bg-slate-50/50 dark:hover:bg-slate-800/40">
      ...
      <td className="px-4 py-3">
        <div className="flex items-center gap-1">
          ...
          <Link to={`/admin/clubs/${clubRouteSegment(club)}/recruitment`} className="rounded-lg px-2 py-1.5 text-sm font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-white/10 inline-flex items-center gap-1" title="Recruitment"><Briefcase className="h-4 w-4" /> Recruitment</Link>
          ...
          {menuOpen && (
            <>
              ...
              <div className="fixed z-50 w-48 max-h-[70vh] overflow-y-auto rounded-xl border border-slate-200 bg-white py-1 shadow-lg dark:border-[#1e2d42] dark:bg-[#161f2e]" style={{ top: menuPos.top, bottom: menuPos.bottom, right: menuPos.right }}>
                ...
                <Link to={`/admin/clubs/${clubRouteSegment(club)}/recruitment`} className="flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700" onClick={() => setMenuOpen(false)}>Recruitment</Link>
                <Link to={`/admin/clubs/${clubRouteSegment(club)}/team`} className="flex w-full items-center gap-2 px-3 py-2 text-left text-sm text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-700" onClick={() => setMenuOpen(false)}>View Members</Link>
