...
const DRIVES = [
  ...
  { id: 2, club: "Creative Arts Society", role: "Social Media Lead", desc: "Manage our Instagram and Behance presence. Must have an eye for aesthetic layouts and trending content.", badge: "7 days left", badgeClass: "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400", applicants: 6, open: true },
  { id: 3, club: "E-Cell", role: "Sponsorship Manager", desc: "Reach out to corporate partners for our annual E-Summit. Excellent communication skills are a must.", badge: "4 days left", badgeClass: "bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-400", applicants: 23, open: true },
  { id: 4, club: "Robotics Society", role: "Hardware Engineer", desc: "Design and assemble PCBs for the upcoming inter-college robot wars event.", badge: "Closed", badgeClass: "bg-slate-200 text-slate-500 dark:bg-slate-800 dark:text-slate-500", applicants: 1, open: false },
];
    ...
    <div className="min-h-screen bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="block h-12 w-full rounded-xl border border-slate-200 bg-white pl-12 pr-4 text-sm focus:border-transparent focus:ring-2 focus:ring-primary dark:border-slate-800 dark:bg-slate-900 dark:text-white"
              />
            </div>
          </div>
            ...
            {DRIVES.map((drive) => (
              ...
              >
                <div className="mb-4 flex items-start gap-4">
                  <div className="flex size-14 shrink-0 items-center justify-center rounded-lg border border-slate-200 bg-slate-100 dark:border-slate-700 dark:bg-slate-800">
                ...
                <div className="flex items-center justify-between border-t border-slate-100 pt-4 dark:border-slate-800">
                  <div className="flex -space-x-2">
                    <div className="size-7 rounded-full border-2 border-white bg-slate-200 dark:border-slate-900" />
                    <div className="size-7 rounded-full border-2 border-white bg-slate-300 dark:border-slate-900" />
                    <div className="flex size-7 items-center justify-center rounded-full border-2 border-white bg-slate-400 text-[10px] font-bold dark:border-slate-900">
                      +{drive.applicants - 2}
                    </div>
                  </div>
                  {drive.open ? (
                    ...
                    <button
                      type="button"
                      disabled
                      className="cursor-not-allowed rounded-lg bg-slate-200 px-6 py-2 text-xs font-bold text-slate-500 dark:bg-slate-800"
                    >
                      Application Closed
                    </button>
                  )}
      ...
      {quickOpen && (
        <div className="fixed inset-0 z-40 flex justify-end bg-black/10">
          ...
          />
          <aside className="relative flex h-full w-full max-w-md flex-col bg-white shadow-2xl md:mr-6 md:mt-6 rounded-none md:rounded-2xl dark:bg-slate-900">
            <div className="border-b border-slate-200 bg-slate-50/60 p-5 dark:border-slate-800 dark:bg-slate-800/40 flex items-center justify-between">
              <div>
            ...
            >
              <div className="flex flex-col gap-1">
                ...
                <textarea
                  ...
                  rows={4}
                  className="min-h-[120px] w-full rounded-lg border border-slate-200 bg-slate-50 p-3 text-sm focus:ring-2 focus:ring-primary focus:border-transparent dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                />
              </div>
              <div className="flex flex-col gap-1">
                <label className="text-xs font-bold text-slate-900 dark:text-slate-300">
                ...
                <input
                  ...
                  className="h-10 w-full rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm focus:ring-2 focus:ring-primary focus:border-transparent dark:border-slate-700 dark:bg-slate-800 dark:text-white"
                />
              </div>
              <div className="flex flex-col gap-1">
                <label className="text-xs font-bold text-slate-900 dark:text-slate-300">
                ...
                <div className="flex cursor-pointer flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-slate-200 p-6 text-center transition-colors hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800">
