      ...
      <div className="flex h-full min-h-screen w-full flex-col overflow-x-hidden">
        <main className="flex flex-1 justify-center px-4 py-10 md:px-20 lg:px-40">
          <div className="flex max-w-[1200px] flex-1 flex-col">
            ...
            {/* Search */}
            <div className="mb-6">
              <label htmlFor="student-club-directory-search" className="group flex h-14 w-full min-w-40 flex-col">
              <div className="flex h-full w-full flex-1 items-stretch rounded-xl border border-slate-200 bg-white shadow-sm ring-1 ring-slate-200 transition-all focus-within:ring-2 focus-within:ring-primary dark:border-[#1e2d42] dark:bg-[#161f2e] dark:ring-slate-800">
                <div className="flex items-center justify-center rounded-l-xl bg-white pl-5 text-slate-400 dark:bg-[#161f2e]">
                  ...
                  <input
                    id="student-club-directory-search"
                    name="student-club-directory-search"
                    type="text"
                ...
                <button
                  ...
                  className={`flex h-10 shrink-0 items-center justify-center gap-x-2 rounded-full px-6 transition-all ${
                    category === cat
                     ...
                     : "border border-slate-300 bg-white text-slate-800 hover:bg-slate-100 hover:border-slate-400 dark:border-[#1e2d42] dark:bg-[#161f2e] dark:text-slate-300 dark:hover:bg-slate-700"
                  }`}
                >
